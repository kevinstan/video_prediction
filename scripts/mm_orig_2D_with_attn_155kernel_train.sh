...
python -u run.py \
    ...
    --log_dir logs/_mm_orig_3D_with_attn_155kernel \
    --save_dir checkpoints/_mm_orig_3D_with_attn_155kernel \
    --gen_frm_dir results/_mm_orig_3D_with_attn_155_kernel \
    --model_name original_e3d_lstm \
