...
python -u run.py \
    ...
    --log_dir logs/_3Denc_2Dlstm_3Ddec_l2l1loss_4layer_concat \
    --save_dir checkpoints/_mnist_3Denc_2Dlstm_3Ddec_4layer_concat \
    --gen_frm_dir results/_mnist_3Denc_2Dlstm_3Ddec_4layer_concat \
    --model_name e3d_lstm_concat \
